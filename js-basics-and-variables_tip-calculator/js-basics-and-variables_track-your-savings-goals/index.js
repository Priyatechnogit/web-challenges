...
let numerOfMonths = 12;
let totalSavings = startingBalance + (monthlyContribution * numerOfMonths);
console.log("Starting balance: $" +startingBalance);
console.log("Monthly contribution: $"+ monthlyContribution);
console.log("Numer of months : "+numerOfMonths);
console.log("My total saving after a year is: $" + totalSavings);
